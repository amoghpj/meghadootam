...
\section*{{\dn \dnnum 60}}
\begin{enumerate}
\item[{\dn praaleyaadrerupata.tamatikramya}] 
\item[{\dn taa.mstaanvi"se.saa-}] 
\item[{\dn nha.msadvaara.m}] 
\item[{\dn B.rgapati"sayovartma}] 
\item[{\dn yatkrau~ncaranDra.m}] 
\item[{\dn tenodiicii.m}] 
\item[{\dn di"samanusarestiryagaayaama"soBii}] 
\item[{\dn "syaamaH paado}] 
\item[{\dn baliniyamanaaByudyanasyeva vi.s.noH}] 
\end{enumerate}
#+end_src
* footer
  :PROPERTIES:
