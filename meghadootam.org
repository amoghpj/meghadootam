...
\item[{\dn halaB.rto}] Like the Plough bearer's (balar\={a}ma, who is fair skinned) 
...
\item[{\dn ma.nita.taaroha.naayaagrayaayii}] so as to let Gauri step on this jeweled platform \footnote{Kailasa is said to be made of jewels}
\end{enumerate}
#+end_src
** 64
   :PROPERTIES:
...
\item[{\dn valayakuli"saH}] using their jeweled bracelets
...
\section*{\dn \dnnum 65}
\begin{enumerate}
\item[{\dn hemaamBojaprasavi salila.m}] 
\item[{\dn maansastaadadaanaH}] 
\item[{\dn krvanjaama.m}] 
\item[{\dn k.sa.namuKapa.tapriitimairaavatasya}] 
\item[{\dn Dunvankalpadrumadiasalaraanya.m"sukaaniiva}] 
\item[{\dn vaataiH}] 
\item[{\dn naanaace.stairjalada}] 
\item[{\dn lalitairnirvi.sesta.m}] 
\item[{\dn nagendra.m}] 
\end{enumerate}
#+end_src
* footer
